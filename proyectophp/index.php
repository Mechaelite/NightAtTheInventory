...
.modal-content {
    ...
    background-image:url('imagenes/LOGIN_Trans.png');
...
<div class="container2" >
    ...
    <div class="imgcontainer">
      ...
      <img src="imagenes/viking.png" alt="Avatar" class="avatar">
    </div>

    <div class="container1">
    
      <label><b>email</b></label>
      <input type="text" placeholder="Enter email" name="email" maxlength="60" value= " <?php if (isset($_POST['USREmail'])) echo $_POST['USREmail'];?>" required>

      <label><b>Password</b></label>
      <input type="password" placeholder="Enter Password" name="pass" maxlength="40"
