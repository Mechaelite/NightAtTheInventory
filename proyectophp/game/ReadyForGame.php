...
<div id="id02" class="modal">
    <form class="modal-content animate" action="start_game.php"> <!-- A completar el action-->
...
<div id="id03" class="modal">
    <form class="modal-content animate" action="/"> <!-- A completar el action-->
...
<div class="container1" >
    ...
    <div class="container1">
      ...
      <input type="text" placeholder="Select your game name" name="name_game" maxlength="40"
        ...
        <label><b>Your Character</b></label>  
...
// Make the query:
$q = "SELECT name_game,pj_game FROM game";      
...
if ($num > 0) { // If it ran OK, display the records.
    ...
    echo "<p>There are currently $num registered games.</p>\n";
...
';
    ...
    while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
        echo '<tr><td align="left">' . $row['name_game'] . '</td><td align="left">' . $row['pj_game'] . '</td></tr>
        ';
    }
