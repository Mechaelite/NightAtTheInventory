...
<div class="container">
        <ul>
            ...
            <li><a class="active" href="indexarmor.php">Armor</a></li>
...
// Make the query:
$q = "SELECT ArmorName, ArmorLevel, ArmorDescription, ArmorType FROM armor";
...
if ($num > 0) { // If it ran OK, display the records.
    ...
    <tr><td align="center"><h2><b>Armor Name</b></h2></td><td align="center"><h2><b>Armor Level</b></h2></td><td align="center"><h2><b>Armor Description</b></h2></td><td align="center"><h2><b>Armor Type</b></h2></td></tr>
';

    // Fetch and print all the records:
    while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
        echo 
        '<tr><td align="center">' . $row['ArmorName'] . '</td>
        <td align="center">' . $row['ArmorLevel'] . '</td>
        <td align="center">' . $row['ArmorDescription'] . '</td>
        <td align="center">' . $row['ArmorType'] . '</td><</tr>';
    }
    ...
    echo '<p class="error">There are currently no registered armors.</p>';
